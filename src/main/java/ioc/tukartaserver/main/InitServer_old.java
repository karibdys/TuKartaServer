...
import ioc.tukartaserver.server.Server_old;
 ...
 * @author  Manu Mora
 */
public class InitServer_old extends javax.swing.JFrame {
  ...
  public static void main(String args[]) {
    /* Set the Nimbus look and feel */        //<editor-fold defaultstate="collapsed" desc=" Look and feel setting code (optional) ">
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InitServer_old.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        public void run() {
          new InitServer_old().setVisible(true);
        }
        });
  }
